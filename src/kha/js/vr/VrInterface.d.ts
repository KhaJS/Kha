...
export class VrInterface extends kha_vr_VrInterface {
	...
	onResetPose():void;
	onAnimationFrame(timestamp:any):void;
	onResize():void;
	GetSensorState():SensorState;
	GetPredictedSensorState(time:any):SensorState;
	WarpSwapBlack():void;
	...
	GetProjectionMatrix(eye:any):FastMatrix4;
	GetViewMatrix(eye:any):FastMatrix4;
